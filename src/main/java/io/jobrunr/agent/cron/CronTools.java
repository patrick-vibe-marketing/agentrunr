...
public class CronTools {
    ...
    private AgentResult scheduleTask(Map<String, Object> args, io.jobrunr.agent.core.AgentContext ctx) {
    ...
    private AgentResult listScheduledTasks(Map<String, Object> args, io.jobrunr.agent.core.AgentContext ctx) {
    ...
    private AgentResult cancelScheduledTask(Map<String, Object> args, io.jobrunr.agent.core.AgentContext ctx) {
